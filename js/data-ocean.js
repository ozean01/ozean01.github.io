...
(function () {
  ...
  FTE_DATA.units.push({
    ...
    vocab: [
      ...
      { w: "OT/FR", ipa: "/ˌoʊ ˈtiː, ˌef ˈɑː/", pos: "n.", cn: "开顶箱／框架箱（Open Top / Flat Rack）", ex: "The oversized slitting machine needs an OT or FR, not a normal box.", exCn: "这台超尺寸分切机要用开顶箱或框架箱，普通箱装不了。" },
      { w: "ocean freight (O/F)", ipa: "/ˌoʊʃn ˈfreɪt/", pos: "n.", cn: "海运费（Ocean Freight，简称 O/F）", ex: "Ocean freight to Hamburg went up three hundred dollars per FEU this week.", exCn: "本周到汉堡的海运费每四十尺箱涨了三百美元。" },
      ...
      { w: "ORC", ipa: "/ˌoʊ ɑːr ˈsiː/", pos: "n.", cn: "本地出口附加费（Origin Receiving Charge）", ex: "South China shipments always carry ORC, so include it in your quotation.", exCn: "华南出口一直有本地费，报价时请把它算进去。" },
      { w: "DOC", ipa: "/ˌdiː oʊ ˈsiː/", pos: "n.", cn: "文件费／单证费（Document Fee）", ex: "The DOC fee is fifty dollars per bill of lading, whoever pays it.", exCn: "不管谁付，单证费都是每票提单五十美元。" },
      ...
      { w: "S/O", ipa: "/ˌes ˈoʊ/", pos: "n.", cn: "订舱单／装货单（Shipping Order）", ex: "The S/O shows the vessel, the voyage and the empty container depot.", exCn: "订舱单上写明船名、航次和提空箱的堆场。" },
      ...
      { w: "D/O", ipa: "/ˌdiː ˈoʊ/", pos: "n.", cn: "提货单（Delivery Order）", ex: "The consignee exchanges the original B/L for a D/O at the agent's counter.", exCn: "收货人在代理柜台用提单正本换取提货单。" },
      ...
      { w: "POL/POD", ipa: "/ˌpiː oʊ ˈel, ˌpiː oʊ ˈdiː/", pos: "n.", cn: "装货港／卸货港（Port of Loading / Port of Discharge）", ex: "POL is Ningbo and POD is Felixstowe, with one transshipment at Singapore.", exCn: "装货港是宁波，卸货港是费利克斯托，在新加坡中转一次。" },
      { w: "cut-off time", ipa: "/ˈkʌt ɑːf taɪm/", pos: "n.", cn: "截关／截港时间（Cut-off Time）", ex: "The port cut-off time is Thursday 17:00, and documents close one day earlier.", exCn: "截关时间是周四下午五点，截单再早一天。" },
      ...
      { w: "rollover", ipa: "/ˈroʊloʊvə/", pos: "n.", cn: "甩柜／甩货（船公司将货柜改至下一航次）", ex: "Our two boxes suffered a rollover and will sail on next week's vessel.", exCn: "我们两个柜子被甩柜了，要搭下周的船。" },
      ...
      { w: "NVOCC", ipa: "/ˌen viː oʊ siː ˈsiː/", pos: "n.", cn: "无船承运人（Non-Vessel Operating Common Carrier）", ex: "As an NVOCC our forwarder can issue its own house bill of lading.", exCn: "作为无船承运人，我们的货代可以签发自己的货代提单。" },
      ...
      { w: "shipper/consignee", ipa: "/ˈʃɪpə, ˌkɑːnsaɪˈniː/", pos: "n.", cn: "发货人／收货人（Shipper / Consignee）", ex: "The shipper is our factory and the consignee is the buyer's packaging plant.", exCn: "发货人是我们工厂，收货人是买方的包装厂。" },
