...
(function () {
  ...
  FTE_DATA.units.push({
    ...
    vocab: [
      { w: "Incoterms", ipa: "/ˈɪŋkəʊtɜːmz/", pos: "n.", cn: "国际贸易术语解释通则（International Commercial Terms）", ex: "All prices in this offer are based on Incoterms 2020 published by the ICC.", exCn: "本报价中的所有价格均以国际商会发布的 Incoterms 2020 为准。" },
      ...
      { w: "FOB", ipa: "/ˌef əʊ ˈbiː/", pos: "n.", cn: "装运港船上交货、离岸价（Free On Board）", ex: "Our price is USD 3.20 per kilogram FOB Shenzhen, Incoterms 2020.", exCn: "我们的价格是每公斤 3.20 美元，深圳港离岸价，适用 Incoterms 2020。" },
      ...
      { w: "point of delivery", ipa: "/ˌpɔɪnt əv dɪˈlɪvəri/", pos: "n.", cn: "交货地点（point of delivery）", ex: "Please confirm the exact point of delivery, otherwise the term is open to dispute.", exCn: "请确认具体交货地点，否则该术语容易产生争议。" },
      ...
      { w: "port of loading", ipa: "/ˌpɔːt əv ˈləʊdɪŋ/", pos: "n.", cn: "装运港（port of loading）", ex: "Our usual port of loading is Yantian, but we can also ship from Shekou.", exCn: "我们常用的装运港是盐田，但也可以从蛇口出运。" },
      ...
      { w: "Institute Cargo Clauses A", ipa: "/ˈɪnstɪtjuːt ˈkɑːɡəʊ ˈklɔːzɪz ˈeɪ/", pos: "n.", cn: "协会货物条款 A、一切险（Institute Cargo Clauses A）", ex: "Under CIP we cover the cargo under Institute Cargo Clauses A for the full value.", exCn: "在 CIP 条件下我们按协会货物条款 A 就全部货值投保。" },
