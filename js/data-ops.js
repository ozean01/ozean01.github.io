...
(function () {
  ...
  FTE_DATA.units.push({
    ...
    vocab: [
      ...
      { w: "order confirmation", ipa: "/ˈɔːdə ˌkɒnfəˈmeɪʃn/", pos: "n.", cn: "订单确认书（OC）", ex: "Our order confirmation will be sent to you within two working days.", exCn: "我们的订单确认书会在两个工作日内发给你。" },
      ...
      { w: "proforma invoice", ipa: "/prəʊˈfɔːmə ˈɪnvɔɪs/", pos: "n.", cn: "形式发票（PI）", ex: "Please countersign the proforma invoice so that we can start production planning.", exCn: "请回签形式发票，我们好安排生产计划。" },
      ...
      { w: "certificate of origin", ipa: "/səˈtɪfɪkət əv ˈɒrɪdʒɪn/", pos: "n.", cn: "原产地证（CO）", ex: "We will apply for a certificate of origin to reduce your import duty.", exCn: "我们会申请原产地证，帮你降低进口关税。" },
      ...
      { w: "HS code", ipa: "/ˌeɪtʃ ˈes kəʊd/", pos: "n.", cn: "海关商品编码（HS 编码）", ex: "The HS code for our solvent-based laminating adhesive is 3506910090.", exCn: "我们溶剂型复膜胶的 HS 编码是 3506910090。" },
      { w: "customs broker", ipa: "/ˈkʌstəmz ˈbrəʊkə/", pos: "n.", cn: "报关行，报关代理", ex: "Our customs broker in Ningbo handles all the export paperwork for us.", exCn: "宁波的报关行帮我们处理所有出口文件。" },
      ...
      { w: "inspection and quarantine", ipa: "/ɪnˈspekʃn ənd ˈkwɒrəntiːn/", pos: "n.", cn: "检验检疫，报检", ex: "Chemical goods need inspection and quarantine before the container is loaded.", exCn: "化工品在装柜前需要办理检验检疫。" },
      ...
      { w: "inner box", ipa: "/ˈɪnə bɒks/", pos: "n.", cn: "内盒，中盒", ex: "Each inner box holds 500 pouches with a desiccant bag inside.", exCn: "每个内盒装 500 个包装袋，里面放一包干燥剂。" },
      ...
      { w: "gross weight", ipa: "/ɡrəʊs weɪt/", pos: "n.", cn: "毛重（G.W.）", ex: "Total gross weight is 4,280 kilograms including the pallets.", exCn: "含托盘总毛重是 4,280 公斤。" },
      ...
      { w: "deposit", ipa: "/dɪˈpɒzɪt/", pos: "n.", cn: "定金，预付款", ex: "We will arrange production once the 30 percent deposit reaches our account.", exCn: "30% 定金到账后我们就安排生产。" },
      ...
      { w: "booking note", ipa: "/ˈbʊkɪŋ nəʊt/", pos: "n.", cn: "订舱委托书（B/N，等同 S/O 订舱单）", ex: "The forwarder sent the booking note this morning; the cut-off is Thursday noon.", exCn: "货代今天上午发来订舱单，截关是周四中午。" },
      ...
      { w: "consignee", ipa: "/ˌkɒnsaɪˈniː/", pos: "n.", cn: "收货人", ex: "The consignee on the bill of lading must be your Rotterdam branch.", exCn: "提单上的收货人必须是你们鹿特丹分公司。" },
      { w: "notify party", ipa: "/ˈnəʊtɪfaɪ ˈpɑːti/", pos: "n.", cn: "通知方", ex: "Please confirm whether the notify party is the same as the consignee.", exCn: "请确认通知方是否与收货人相同。" },
      ...
      { w: "consistency of documents", ipa: "/kənˈsɪstənsi əv ˈdɒkjumənts/", pos: "n.", cn: "单单一致", ex: "Under a letter of credit, consistency of documents decides whether you get paid.", exCn: "在信用证项下，单单一致决定你能否收到钱。" }
    ],
    phrases: [
