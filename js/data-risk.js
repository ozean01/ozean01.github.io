...
(function () {
  ...
  FTE_DATA.units.push({
    ...
    vocab: [
      { w: "breach of contract", ipa: "/ˌbriːtʃ əv ˈkɒntrækt/", pos: "n.", cn: "违约（违反合同）", ex: "Late delivery amounted to a material breach of contract and entitled us to cancel.", exCn: "迟交货构成实质性违约，我们有权解除合同。" },
      ...
      { w: "nonperformance", ipa: "/ˌnɒnpəˈfɔːməns/", pos: "n.", cn: "不履行（未按约履行）", ex: "We will not accept the goods after such continued nonperformance by the supplier.", exCn: "在供应商如此持续不履行后，我们将不再收货。" },
      { w: "warranty", ipa: "/ˈwɒrənti/", pos: "n.", cn: "保证、担保（warranty）", ex: "We warrant the film is free from defects for 12 months from the date of shipment.", exCn: "我们保证该薄膜自装运之日起 12 个月内无缺陷。" },
      ...
      { w: "confidentiality", ipa: "/ˌkɒnfɪˌdenʃiˈæləti/", pos: "n.", cn: "保密性（保密条款）", ex: "Both parties shall keep the formula and pricing strictly confidential for five years.", exCn: "双方应在五年内对配方与价格严格保密。" },
      { w: "notice", ipa: "/ˈnəʊtɪs/", pos: "n.", cn: "通知（正式通知）", ex: "Any notice must be given in writing and sent to the registered address of the other party.", exCn: "任何通知须以书面形式发送至对方注册地址。" },
      ...
      { w: "food contact material", ipa: "/ˌfuːd ˈkɒntækt məˈtɪəriəl/", pos: "n.", cn: "食品接触材料", ex: "As a food contact material, the adhesive must meet the migration limits of Regulation 1935/2004.", exCn: "作为食品接触材料，该复合胶须符合 1935/2004 法规的迁移限量。" },
      ...
      { w: "RoHS", ipa: "/rəʊ ˌeɪtʃ ˈes/", pos: "n.", cn: "有害物质限制指令（限制铅汞镉等）", ex: "The heating element is RoHS compliant, which we can prove by the test report.", exCn: "该加热元件符合 RoHS，可由检测报告证明。" },
