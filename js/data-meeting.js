...
(function () {
  ...
  FTE_DATA.units.push({
    ...
    vocab: [
      ...
      { w: "value proposition", ipa: "/ˈvæljuː ˌprɒpəˈzɪʃn/", pos: "n.", cn: "价值主张", ex: "Our value proposition is lower total cost, not just a lower unit price.", exCn: "我们的价值主张是更低的总成本，而不只是更低的单价。" },
      ...
      { w: "product demo", ipa: "/ˈprɒdʌkt ˈdeməʊ/", pos: "n.", cn: "产品演示", ex: "We will run a live product demo and show the peel strength test on site.", exCn: "我们会现场做产品演示，并做剥离强度测试。" },
      ...
      { w: "follow-up", ipa: "/ˈfɒləʊ ʌp/", pos: "n.", cn: "跟进，后续动作", ex: "We will send the follow-up with all action items and owners by Friday.", exCn: "我们周五前会发出含所有行动项和负责人的跟进纪要。" },
      { w: "minutes", ipa: "/ˈmɪnɪts/", pos: "n.", cn: "会议纪要", ex: "I will circulate the minutes right after the call.", exCn: "会议结束后我会立刻分发会议纪要。" },
      { w: "stakeholder", ipa: "/ˈsteɪkhəʊldə/", pos: "n.", cn: "利益相关方，干系人", ex: "Your procurement and quality teams are both stakeholders in this decision.", exCn: "贵司的采购和质检团队都是这个决策的利益相关方。" },
