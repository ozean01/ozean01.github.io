  ...
  const GROUPS = [
    {
      ...
      items: [
        { wrong: "Please send me your price.", right: "Please send us your quotation / price list.",
          ...
          ex: "Please send us your latest quotation for the stand-up pouches.", exCn: "请把站立袋的最新报价单发给我们。" },
        { wrong: "We very thank you for your support.", right: "We are very grateful for your support / Thank you very much for your support.",
          ...
          ex: "We are very grateful for your support during this trial order.", exCn: "我们对贵方在这一试单过程中的支持深表感谢。" },
        { wrong: "I hope you can give me your best price.", right: "Could you offer us your best price? / We would appreciate your best price.",
          ...
          ex: "We would appreciate your best price for a 20,000-piece order.", exCn: "我们希望能得到 2 万件订单的最优报价。" },
        { wrong: "Our factory is very strong.", right: "Our factory has a strong production capacity / We are an experienced manufacturer.",
          ...
          ex: "Our factory is an experienced flexible-packaging manufacturer with a strong monthly capacity.", exCn: "我们工厂是有经验、月产能很强的软包装制造商。" },
        { wrong: "We can delivery in 30 days.", right: "We can deliver within 30 days. / The lead time is 30 days.",
          ...
          ex: "We can deliver within 30 days after receipt of your deposit.", exCn: "收到定金后我们可在 30 天内交货。" },
        { wrong: "I will contact you if you have problem.", right: "I will contact you if there is any problem. / if you have any questions.",
          ...
          ex: "Please let us know if you have any questions before we arrange the shipment.", exCn: "在我们安排装运前，如有任何问题请告知我们。" }
      ]
    },
    {
      id: "near-synonyms",
      ...
      items: [
        { wrong: "We will send the quotation / We are going to send the quotation.",
          ...
          ex: "We are going to increase the price next month, so we will send you today's quote now.", exCn: "我们下个月要涨价，所以现在就把今天的报价发给您。" },
        { wrong: "Could you quote me the price / Could you quote the price to me.",
          ...
          ex: "Could you send us a quotation for 10 tons of laminating adhesive?", exCn: "能否为 10 吨复合胶给我们发一份报价？" },
        { wrong: "The price is high / low.", right: "The price is competitive / the cost is high.",
          ...
          ex: "Our price is competitive for this specification and quantity.", exCn: "在这一规格与数量下，我们的价格是有竞争力的。" },
        { wrong: "This is a sample for free.", right: "This sample is free of charge. / We can provide a free sample.",
          ...
          ex: "We provide a free sample; you only pay the courier cost.", exCn: "我们免费提供样品，您只需付快递费。" }
      ]
    },
    {
      id: "grammar-tense",
      ...
      items: [
        { wrong: "We will arrange shipment in this week.", right: "We will arrange shipment this week / within this week.",
          ...
          ex: "We will arrange shipment this week and update you on the vessel.", exCn: "我们本周安排装运，并告知您船期。" },
        { wrong: "Please check the packing list and B/L.", right: "Please check the packing list and the B/L.",
          ...
          ex: "Please check the packing list and the bill of lading before we confirm.", exCn: "请在确认前核对装箱单与提单。" },
        { wrong: "We have in stock two kinds of film.", right: "We have two kinds of film in stock.",
          ...
          ex: "We currently have two kinds of barrier film in stock.", exCn: "我们目前有两种阻隔膜现货。" },
        { wrong: "The machine has been running for 3 years.", right: "The machine has been in operation for 3 years.",
          ...
          ex: "Our laminating line has been in operation for 8 years with stable quality.", exCn: "我们的复合生产线已稳定运行 8 年。" }
      ]
    },
    {
      id: "industry-terms",
      ...
      items: [
        { wrong: "laminate / lamination 混用，直接把 film 说成 laminated.", right: "laminate (v. 复合) / lamination (n. 复合工艺) / laminated film (复合膜).",
          ...
          ex: "We laminate two layers of film with a solvent-free adhesive to produce the laminated film.", exCn: "我们用无溶剂胶复合两层薄膜，制成复合膜。" },
        { wrong: "The coating thickness is 3 gs / 3 ga.", right: "The coating weight is 3 g/m². / The film is 25 microns thick.",
          ...
          ex: "The adhesive coating weight is maintained at 3 g/m² for this lamination.", exCn: "此次复合将上胶量控制在 3 g/m²。" },
        { wrong: "We use recycle material.", right: "We use recycled / post-consumer recycled (PCR) material.",
          ...
          ex: "This pouch uses 30% post-consumer recycled (PCR) material.", exCn: "这款袋采用 30% 的消费后回收材料。" },
        { wrong: "The bag is waterproof / water-proof.", right: "The bag is moisture-resistant / has a high barrier to moisture.",
          ...
          ex: "This laminated film provides a high moisture and oxygen barrier for food packaging.", exCn: "这种复合膜为食品包装提供优异的防潮与隔氧阻隔性。" },
        { wrong: "We will arrange the delivery date.", right: "We will confirm the delivery date / the shipment schedule.",
          ...
          ex: "We will confirm the delivery date once the production schedule is fixed.", exCn: "生产计划确定后，我们会与您确认交期。" }
      ]
    }
  ];
